...
describe("Operaciones CRUD de cafes", () => {
    ...
    it("Obteniendo status code 404 al eliminar un café con un id inexistente DELETE/cafes/:id", async () => {
    ...
    it("Obteniendo un código 404 al enviar un café para editar con req.body.id y req.params.id diferentes en PUT/cafes/:id", async () => {
        const id = 7;
